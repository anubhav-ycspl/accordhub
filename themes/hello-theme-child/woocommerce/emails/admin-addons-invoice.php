...
<body style="font-family:Inter,sans-serif; font-size:9pt;margin:20px">
    ...
    <div style="width:100%; margin-top:10px; display:inline-block; height: auto;">
        <div style="width:50%; display:inline-block; vertical-align:top; margin-left:2%; float: right; color: #2e2e2e;">
            <table style="width:100%; border-collapse:collapse;">
                ...
                <tr>
                    <td
                        style="padding:8px 10px 8px 10px; text-align:right; font-size:11pt; font-weight:600; background-color: #1763B9; color:white; border-top:.5px solid #D4D7E3;">
                        Total Payable
                    </td>
                    <td
                        style="padding:8px 20px 8px 10px; text-align:right; font-size:11pt; font-weight:600; background-color: #1763B9; color:white; border-top:.5px solid #D4D7E3;">
