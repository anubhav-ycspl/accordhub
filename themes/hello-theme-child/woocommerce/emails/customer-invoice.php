...
<body style="font-family:Inter,sans-serif; font-size:9pt;margin:20px">
					...
					<table style="width:100%; border-collapse:collapse; margin-top:5px;">
						<tr>
							...
							<td
								...
								<?php echo $orig->get_meta('_unique_apl_id'); ?>
							</td>
						</tr>
						<tr>
							<td
		...
		<tbody>
			<tr style="background-color: #F4FAFF;">
				...
				<td style="border:.5px solid #D4D7E3; padding:6px 20px 6px 8px; text-align:right;color: #2e2e2e;">
					<?php echo wc_price($booking['price']); ?>
				</td>
			</tr>
	...
	if ($orig->get_meta('group_parent_order') || $orig->get_meta('group_payment_mode') == 'group') {
		$total_label = 'Payable Amount (Your Share)';
	} else {
			...
			<table style="width:100%; border-collapse:collapse;">
				<tr>
					...
					<td style="padding:8px 20px 8px 10px; text-align:right;font-size:10pt;font-weight:600;">
						<?php echo wc_price($booking['total']); ?>
					</td>
				</tr>
				<?php if ($booking['discount'] > 0): ?>
					<tr>
						<td
							...
							Discount (<?php echo $percentage; ?>%)</td>
						<td
							style="padding:8px 20px 8px 10px; text-align:right;font-size:10pt;color: #2e2e2e;border-top:.5px solid #D4D7E3;">
