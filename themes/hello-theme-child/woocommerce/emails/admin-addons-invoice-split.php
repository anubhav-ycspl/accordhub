            ...
            ?>
                <tr style="background-color: #F4FAFF;">
                    ...
                    <td style="border:.5px solid #D4D7E3; padding:8px;">
                        <span
                            style="color: #191919; text-transform:uppercase;"><?php echo $brand_image; ?><strong><?php echo esc_html($product_name); ?></strong></span>
        ...
        <div style="width:60%; display:inline-block; vertical-align:top; margin-left:2%; float: right; color: #2e2e2e;">
            <table style="width:100%; border-collapse:collapse;">
                ...
                <!-- <?php if ($prices_include_tax): ?>
                    <tr>
                        <td style="padding:8px 10px; text-align:right; font-size:10pt;font-weight:600; color: #2e2e2e;">Sub-total:</td>
                        <td style="padding:8px 20px 8px 10px; text-align:right; font-size:10pt;">
                ...
                <tr>
                    <td
                        style="padding:8px 10px; text-align:right; font-size:10pt; color: #2e2e2e;font-weight:600; ">
                        Add-Ons Total</td>
                    <td
                        style="padding:8px 20px 8px 10px; text-align:right; font-size:10pt;font-weight:600;">
                        <?php echo wc_price($base_net_subtotal - $discount); ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td
                        style="padding:8px 10px; text-align:right; font-size:10pt; color: #2e2e2e;font-weight:600; border-top:.5px solid #D4D7E3;">
                        Your Split Share</td>
                    <td
                ...
                <tr>
                    <td
                        style="padding:8px 10px 8px 10px; text-align:right; font-size:10pt; font-weight:600; background-color: #1763B9; color:white; border-top:.5px solid #D4D7E3;">
                        Total Payable
                    </td>
                    <td
                        style="padding:8px 20px 8px 10px; text-align:right; font-size:10pt; font-weight:600; background-color: #1763B9; color:white; border-top:.5px solid #D4D7E3;">
