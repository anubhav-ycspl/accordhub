...
#inner_wrapper {
	background-color: <?php //echo esc_attr( $body ); ?> transparent;
}
<?php endif; ?>
...
#template_footer #credit {
	border: 0;
	<?php if ( $email_improvements_enabled ) : ?>
		border-top: 0px solid <?php echo esc_attr( $border_color ); ?>;
	<?php endif; ?>
	color: <?php echo esc_attr( $footer_text ); ?>;
	font-family: <?php echo $safe_font_family; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: 12px;
	...
	text-align: center;
	padding: <?php //echo $email_improvements_enabled ? '32px' : '24px 0'; ?> 32px 32px 0;
}
...
#header_wrapper {
	padding: <?php echo $email_improvements_enabled ? '40px 32px 0' : '36px 48px'; ?>;
	display: block;
}
...
h1 {
	...
	font-family: <?php echo $safe_font_family; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
	font-size: <?php echo $email_improvements_enabled ? '28px' : '28px'; ?>;
