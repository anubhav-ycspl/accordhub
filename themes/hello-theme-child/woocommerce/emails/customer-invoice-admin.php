...
// Admin Logic: If not paid yet, use Created Date
if ($order->is_paid()) {
	$order_date = wc_format_datetime($order->get_date_paid());
} else {
...
<head>
	<title>Accordhub Payment Invoice</title>
...
<body style="font-family:Inter,sans-serif; font-size:9pt;margin:20px">
		...
		<tr>
			<td style="width:55%; vertical-align:top; padding-right:20px;">
				<div style="width:100%; margin-top:0;text-align: left;">
					...
					<div style="color: #2e2e2e; font-size:9pt;">
						Booking Ref. No.: <?php echo $booking['id']; ?><br>
	...
	// Discount Logic
	foreach ($inv_order->get_items('coupon') as $coupon_item) {
	...
	$discount_total = $inv_order->get_discount_total();
	?>
