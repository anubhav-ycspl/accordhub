...
<p><?php printf( esc_html__( 'Your account has been successfully created, and you can now experience high-quality ADR spaces designed for smooth, hassle-free hearings.', 'woocommerce' ), esc_html( $user_login ) ); ?></p>
<?php if ( $email_improvements_enabled ) : ?>
	<?php /* translators: %s: Site title */ ?>
	<p>You can log in anytime at <a href="<?php bloginfo('url'); ?>">Accordhub.in</a> and start exploring.</p>
	<?php /* ?>
	...
	<?php */ ?>
	<p class="btn_p"><a href="<?php bloginfo('url'); ?>/login/"><?php printf( esc_html__( 'Login to Get Started', 'woocommerce' ) ); ?></a></p>
<?php else : ?>
...
<?php endif; ?>
	...
	<p><?php printf( esc_html__( 'With your Accordhub account, you can:', 'woocommerce' ) ); ?></p>
	<ul>
		<li><?php printf( esc_html__( 'Browse and book hearing rooms based on the number of participants', 'woocommerce' ) ); ?></li>
		<li><?php printf( esc_html__( 'Manage all your ADR bookings in one place', 'woocommerce' ) ); ?></li>
		<li><?php printf( esc_html__( 'Receive timely updates and support', 'woocommerce' ) ); ?></li>
		<li><?php printf( esc_html__( 'Experience seamless tech and hospitality assistance during your sessions', 'woocommerce' ) ); ?></li>
	</ul>
